      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service) => (
            <article
              key={service.title}
              className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950/80 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition duration-300 hover:-translate-y-1 hover:border-cyan-400/50 hover:shadow-[0_18px_50px_rgba(34,211,238,0.08)]"
            >
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-cyan-400 to-transparent opacity-0 transition duration-300 group-hover:opacity-100" />

              <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-xl border border-zinc-800 bg-zinc-950 text-cyan-400 transition duration-300 group-hover:border-cyan-400/50 group-hover:bg-cyan-400/10">
                <svg
                  className="h-5 w-5"
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <p className="min-h-36 text-sm font-semibold leading-relaxed text-zinc-400 sm:min-h-32 lg:min-h-44">
                {service.description}
              </p>
              ...
              <div className="mt-6 space-y-3 border-t border-zinc-800 pt-4">
                {service.items.map((item) => (
                  <div
                    key={item}
                    className="rounded-lg border border-zinc-800 bg-zinc-900/80 px-4 py-3 text-xs font-bold text-zinc-300 transition duration-300 group-hover:border-zinc-700"
                  >
                    {item}
                  </div>
                ))}
        ...
        <div className="mt-12 rounded-2xl border border-zinc-800 bg-zinc-950/80 px-6 py-8 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] sm:flex sm:items-center sm:justify-between sm:text-left">
          <p className="text-xl font-extrabold tracking-tight text-zinc-100">
            Have a project in mind?
          </p>
          <a
            href="#contact"
            className="mt-5 inline-flex rounded-lg border border-cyan-300 bg-cyan-300 px-5 py-3 text-sm font-bold text-zinc-950 transition duration-300 hover:-translate-y-0.5 hover:bg-cyan-200 sm:mt-0"
          >
            Let’s Work Together
          </a>
        </div>
